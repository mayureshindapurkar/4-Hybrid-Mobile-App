...
// Triggered in the reserve modal to close it
  ...
  $scope.doRegister = function() {
    ...
    $localStorage.storeObject('registerData',$scope.registration);
  ...
  $ionicPlatform.ready(function(){
    ...
    $scope.showGallery = function(){
       ...
       for (var i = 0; i < results.length; i++){
            ...
            console.log('Image URI: ' + results[i]); //Print the image URI
        }
       }, function(error) {
            console.log('Error: ' + JSON.stringify(error));
       });
...
.controller('MenuController', ['$scope', 'dishes', 'favoriteFactory', 'baseURL', '$ionicListDelegate','$ionicPlatform','$cordovaLocalNotification','$cordovaToast', 
            ...
            $scope.addFavorite = function (index) {
                ...
                $ionicPlatform.ready(function(){
                    ...
                    $cordovaToast
                        .show('Added to Favorites ' + $scope.dishes[index].name, 'long', 'center')
        ...
        .controller('DishDetailController', ['$scope', '$stateParams', 'dish','menuFactory','favoriteFactory','baseURL','$ionicListDelegate','$ionicPopover','$ionicLoading','$timeout','$ionicModal','$localStorage','$ionicPlatform','$cordovaLocalNotification','$cordovaToast',  
                    function($scope, $stateParams,dish,menuFactory,favoriteFactory,baseURL,$ionicListDelegate,$ionicPopover,$ionicLoading,$timeout,$ionicModal,$localStorage,$ionicPlatform,$cordovaLocalNotification,$cordovaToast) {
            ...
            $scope.popoverAddFavorite = function(){
                ...
                $ionicPlatform.ready(function(){
                    ...
                    $cordovaToast
                        .show('Added to Favorites ' + $scope.dish.name, 'long', 'center')
                        .then(function(success){
                            //success
                        }, function(error){
                            //error
